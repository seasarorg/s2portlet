...
/**
 * (From org.seasar.teeda.core.util.RequestDumpUtil)
 * 
 * @author shinsuke
 */
public class RequestDumpUtil {
    ...
    public static void dumpRequestHeaders(final StringBuffer sb,
            final PortletRequest request, final String lf, final String indent) {
        // nothing on portlet..
    ...
    public static void dumpContextAttributes(final StringBuffer sb,
            final PortletContext context, final String lf, final String indent) {
        if (context == null) {
            return;
        }
    ...
    public static void dumpSessionAttributes(final StringBuffer sb,
            final PortletRequest request, final String lf, final String indent) {
        final PortletSession session = request.getPortletSession(false);
        if (session == null) {
            return;
        }
    ...
    public static void dumpContextProperties(final StringBuffer sb,
        ...
        sb.append(", PortletContextName=").append(
                context.getPortletContextName());
    ...
    public static void dumpResponseProperties(final StringBuffer sb,
            final PortletResponse response, final String lf, final String indent) {
        sb.append(indent);
